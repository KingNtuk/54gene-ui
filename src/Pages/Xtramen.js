              ...
              <div className="row test-details-block">
                ...
                <div className="col-md-6 testdetails-right">
                  ...
                  <div className="test-card">
                    <h5 className="testdetails testlist-amount px-3">NGN35,000</h5>
                    <Button 
                    title='Buy Now' 
            ...
            <div className="col-md-6">
              <ul className="test-details-down-ul">
                <li className="test-details-down-li">
                  ...
                  level of cholesterol and other fats in your blood. Abnormal levels could make your blood
                  vessels unhealthy thereby increasing the risk of heart disease or stroke.
                </li>
                <li className="test-details-down-li">
                ...
                <li className="test-details-down-li">
                  <b>Liver Function: </b> The liver plays a key role in your body’s metabolism among other functions and this test quantifies the levels of proteins and enzymes produced by the liver to assess its function.
                </li>
                <li className="test-details-down-li">
                  <b>Diabetic Profile (FBS & Hb1Ac): </b> While sugar plays a vital role in the normal functioning of our cells,providing us with energy,
                  abnormally high levels have a detrimental effect on our long term health. Diabetes Mellitus is a disease that results from a dysfunction
                  of our blood glucose regulation and this test panel which includes- Fasting Blood Sugar(FBS) and Glycated Haemoglobin (Hb1Ac) assess blood
                  glucose with a view to diagnose disease or monitor treatment.
                </li>
              </ul>
            </div>
            <div className="col-md-6">
              <ul className="test-details-down-ul">
              <li className="test-details-down-li">
                  <b>Prostate health Markers-Total PSA: </b> Prostatic Surface Antigen (PSA) is a marker of prostate health. The prostate gland is a walnut sized gland that produces fluid to preserve sperm. Abnormality in PSA levels may indicate prostate disease ranging from inflammation to cancer. An abnormally high PSA level which may be indicative of a cancer risk would require further testing to assess the prostate
                </li>
              <li className="test-details-down-li">
        ...
        <div className="test-requirements home-test-list pt-5">
          <div className="row">
            <div className="col-md-3">
              ...
              <p className="requirements-p text-align-center">Blood and Urine</p>
            </div>
        ...
        <div className="row test-down-row">
          <div className="col-md-6">
            ...
            <ul className="test-down-ul">
                ...
                <li className="test-down-li">
                  <b>For Urinalysis: </b>  Early morning mid-stream urine is preferrable (We will be providing the sample bottle for this test). This means that you allow the first bit of urine to flow out before you start collecting while avoiding the last bit of urine. This prevents contaminants from other sources getting into the urine.
                </li>
              </ul>
            </div>
          </div>
