              ...
              <div className="row test-details-block">
                ...
                <div className="col-md-6 testdetails-right">
                  <h4 className="testdetails-h4">
                     Because your health and vitality matters - knowing your status is crucial!
                  </h4>
                  ...
                  <div className="test-card">
                    <h5 className="testdetails testlist-amount px-3">NGN30,0000</h5>
                    {/* <HowToBuy test={'SimplyWell'} /> */}
                    <Button 
                    title='Buy Now' 
                    bgColor='#F2E14F'
        ...
        <div className="row test-down-row">
          ...
          <div className="col-md-6">
            <div className="testdetails-right">
              ...
              <ul className="test-down-ul">
                <li className="test-down-li">
                  <b>Vital organs: </b>The test gives insight into the health of your heart and other vital organs.
                </li>
                <li className="test-down-li">
                  <b>Lifestyle is important: </b>Knowing your health status helps you make better decisions about your lifestyle that can improve your quality of life overall and delay onset of susceptible diseases.
                </li>
                <li className="test-down-li">
